...
@section('contents')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Thêm nhân viên mới vào phòng ban</h4>
                </div>
                <div class="modal-body">
                    <form id="addDepartmentListForm" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="add_employeeNotDepart" class="form-label">Danh sách nhân sự</label>
    ...
    <div class="card shadow-sm p-3 mb-5 bg-white rounded-4">
        <h3 class="text-left mb-4">Danh sách nhân viên của {{$deparmentInfo->department_name}}</h3>
