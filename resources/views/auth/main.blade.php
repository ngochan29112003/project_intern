...
<aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
        <li class="nav-item">
            <a class="nav-link " href="{{route('get-view-dashboard')}}">
        ...
        <li class="nav-item">
            ...
            <ul id="qlnv-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="">
                        <i class="bi bi-circle"></i><span>Cập nhật nhân viên</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#pb-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
                <i class="bi bi-journal-text"></i><span>Phòng ban - vai trò</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#khachhang-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#thietbi-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
                <i class="bi bi-currency-dollar"></i><span>Tài sản thiết bị</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#phanquyen-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#luong-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#du-an1-nav" data-bs-toggle="collapse" href="#" aria-expanded="false">
...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Liên Hệ <strong><span>Admin</span></strong>. Mail: 21004092@st.vlute.edu.vn
    </div>
    <div class="credits">
